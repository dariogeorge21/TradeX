import { ForexIndicatorValue, ForexMACDValue } from "@/types/forex";
import { Gauge, BarChart, TrendingUp } from "lucide-react";

export function ForexTechnicalIndicatorsPanel({
  rsi,
  macd,
  ema,
}: {
        ...
        {latestEma ? (
          <>
            <div className="text-2xl font-bold font-mono mb-2 text-foreground">
              {latestEma.toLocaleString(undefined, { minimumFractionDigits: 5, maximumFractionDigits: 5 })}
            </div>
